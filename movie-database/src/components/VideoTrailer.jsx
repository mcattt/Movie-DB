...
const VideoTrailer = ({videos}) => {
  ...
  return (
    <div > 
        <Link  to={`https://www.youtube.com/watch?v=${videoPath}`} target='_blank' rel='noopener' className='text-bright-orange hover:text-white fill-bright-orange hover:fill-white'>
            <svg className='inline-block'xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" aria-hidden="true" role="img">
