...
const VideoTrailer = ({videos}) => {
  ...
  return (
    ...
    {isVideoExist ? (
      <div> 
          <Link  to={`https://www.youtube.com/watch?v=${videoPath}`} target='_blank' rel='noopener' className='text-light-purple hover:text-bright-orange underline hover:no-underline fill-light-purple hover:fill-bright-orange'>
