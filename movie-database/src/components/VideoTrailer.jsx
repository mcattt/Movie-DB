...
const VideoTrailer = ({videos}) => {
  ...
  return (
    ...
    {isVideoExist ? (
      <div> 
          <Link  to={`https://www.youtube.com/watch?v=${videoPath}`} target='_blank' rel='noopener' className='text-bright-orange fill-bright-orange sm:text-light-purple sm:hover:text-bright-orange underline sm:hover:no-underline sm:fill-light-purple sm:hover:fill-bright-orange'>
