...
const CastInfo = ({ cast }) => {
  ...
  return (
    <div className="cast-info mx-5 z-20 m-[20px_0px_64px_0px] sm:m-[20px_20px_10px_20px] md:col-[1_/_3] md:mx-auto md:my-0 md:px-8 md:py-4 md:w-full min-[950px]:pl-20 min-[1090px]:pl-32 xl:col-[2_/_3] xl:pl-14 2xl:pl-0">
      <h3 className="font-bold mb-2 text-xl">Cast</h3>
      <div className="scrollbar cast-list overflow-x-scroll flex flex-nowrap">
